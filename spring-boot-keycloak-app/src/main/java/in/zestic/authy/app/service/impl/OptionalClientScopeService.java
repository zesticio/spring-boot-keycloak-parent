...
@Service
public class OptionalClientScopeService {

    private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(OptionalClientScopeService.class);

    @Resource(name = "session")
    private Session session;
    protected final KeycloakProperties properties;

    public OptionalClientScopeService(KeycloakProperties properties) {
