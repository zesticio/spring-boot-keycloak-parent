...
import com.zestic.authy.keycloak.utils.Utils;
...
public class Client implements Serializable {
    ...
    public Client(String clientId, String clientSecret, String serverUrl, String realm) {
    ...
    public RoleRepresentation newClientRole(RoleRepresentation roleRepresentation) {
        ...
        if (!roleRepresentation.isComposite()) throw new KeycloakException("Role must be set to Composite ture");
    ...
    public void addClientRolePermissions(final String roleName, List<RoleRepresentation> permissions) {
        ...
        permissions.stream().forEach(p -> {
            if (p.isComposite()) throw new KeycloakException("Permission can not be composite");
        });
        final ClientResource clientResource = getClientResource();
